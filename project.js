...
function paperRequirements(book1, book2, book3) {
    const book01Page = 100
    const book02Page = 200
    const book03Page = 300
    const book01Cost = book01Page * book1
    const book02Cost = book02Page * book2
    const book03Cost = book03Page * book3

    const totalCost = book01Cost + book02Cost + book03Cost
    return totalCost
}
...
const friendNames = ['Masud', 'Abu Taleb hello', 'Abdul Basir', 'Abdur Rahman']
...
console.log(bestFriend(friendNames));
...
let numbers = [50, 60, 20, 40, 30, 56, 25, 15, 685, -36, -45, -8, 63,]
